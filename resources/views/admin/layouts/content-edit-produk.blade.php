...
<section class="is-edit-produk p-5">
    ...
    <section class="modal-card-body">
        <form action="{{ route('produk.update', $produk->id) }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="input-1 mb-3">
            ...
            <div class="mt-2">
              <input id="nama_produk" name="nama_produk" type="text" autocomplete="nama_produk" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" value="{{$produk->nama_produk}}">
            </div>
          </div>
        ...
        <div class="input-3 mb-3">
          ...
          <div class="mt-2">
            <input id="harga" name="harga" type="number" autocomplete="harga" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" value="{{$produk->harga}}">
          </div>
        </div>
